...
class DeliverablesControllerTest < ActionController::TestCase
  ...
  test "should create deliverable" do
    assert_difference('Deliverable.count') do
      post :create, deliverable: { attachment: @deliverable.attachment, description: @deliverable.description, name: @deliverable.name }
    end
  ...
  test "should update deliverable" do
    patch :update, id: @deliverable, deliverable: { attachment: @deliverable.attachment, description: @deliverable.description, name: @deliverable.name }
    assert_redirected_to deliverable_path(assigns(:deliverable))
  end
